...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'une-cle-de-secours-uniquement-en-local')
...
'rest_framework.permissions.AllowAny'           # IsAuthenticated,  Tout est protégé par défaut
],
